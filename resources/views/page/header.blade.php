...
<header id="header">
    <div class="d-flex flex-column">
        ...
        <div class="profile">
            ...
            <h1 class="text-light"><a href="index.html">Brijesh Vamja</a></h1>
            <div class="social-links mt-3 text-center">
                <a href="https://www.linkedin.com/in/brijesh-vamja-194b26269/" target="_blank" class="linkedin"><i
                        class="bx bxl-linkedin"></i></a>
                <a href="https://www.instagram.com/briju_vamja/" target="_blank" class="instagram"><i
                        class="bx bxl-instagram"></i></a>
                <a href="https://www.facebook.com/brijesh.vamja.14" target="_blank" class="facebook"><i
